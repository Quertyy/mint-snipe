...
- `--fees-max` is the maximum amount of fees you want to pay in wei
...
```bash
cargo run -- --contract-address 0x9601482fD8EacE73745Dd7353e17c19F4Ce9142d --mint-method mint --price 1000000000000000 --amount 2 --timestamp 1676816130 --retry-max 5 --fees-max 1000000000000000
```
